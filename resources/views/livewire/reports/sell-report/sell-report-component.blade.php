<div>
    ...
    @section('title',env('App_NAME') .' | '.'Sell Report')
                ...
                <div class="col-lg-12">
                    <div class="card-box">
                        <div class="row header-title">
                            <div class="col-sm-4">
                                <h4 class="header-title mb-0">Sell Report</h4>
                            </div>
                        ...
                        @if ($reports)
                            <div class="card container">
                                ...
                                <h4 class="header-title mb-2 mt-3 text-center">
                                    ...
                                    <a href="{{ route('sell_report_pdf',['from' =>$from,'to'=>$to,'flag'=>$flag ?? 'day']) }}" class="btn btn-sm btn-danger float-right ml-2" target="_blank">Print To PDF</a>
                                    <a href="{{ route('sell_report_excel',['from' =>$from,'to'=>$to,'flag'=>$flag ?? 'day']) }}" class="btn btn-sm btn-success float-right ml-2" target="_blank">Print To Excel</a>
                                </h4>
                    ...
                    {{-- <form role="form" enctype="multipart/form-data" wire:submit.prevent="Store()">
                        ...
                        ======================================-->  
                          <div class="modal-header">
                            <h4 class="modal-title">Bill No: {{ $bill_no }}</h4>
