<div>
    ...
    @section('title',env('App_NAME') .' | '.' Due Sell Report')
                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active"> Due Sell Report</li>
                                {{-- <li class="breadcrumb-item active">Account Settings</li> --}}
                            </ol>
                        </div>
                        <h4 class="page-title"> Due Sell Report</h4>
                    </div>
                </div>
            </div>     
            <!-- end page title --> 
                ...
                <div class="col-lg-12">
                    <div class="card-box">
                        <div class="row header-title">
                            <div class="col-sm-4">
                                <h4 class="header-title mb-0">Due Sell Report</h4>
                            </div>
                        ...
                        @if ($reports)
                            <div class="card container">
                                ...
                                <h4 class="header-title mb-2 mt-3 text-center">
                                    ...
                                    <a href="{{ route('due_sell_report_pdf',['from' =>$from,'to'=>$to,'flag'=>$flag ?? 'day']) }}" class="btn btn-sm btn-danger float-right ml-2" target="_blank">Print To PDF</a>
                                    <a href="{{ route('due_sell_report_excel',['from' =>$from,'to'=>$to,'flag'=>$flag ?? 'day']) }}" class="btn btn-sm btn-success float-right ml-2" target="_blank">Print To Excel</a>
                                </h4>
                                    ...
                                    <tbody>
                                        @foreach ($reports as $key=>$value)
                                            <tr>
                                                ...
                                                <td style="text-align: right">{{ $value->due }}</td>
                                        ...
                                        <tr style="color: red">
                                                ...
                                                <td style="text-align: right"><b>{{ $due_total }}</b></td>
                    ...
                    {{-- <form role="form" enctype="multipart/form-data" wire:submit.prevent="Store()">
                        ...
                        ======================================-->  
                          <div class="modal-header">
                            <h4 class="modal-title">Bill No: {{ $bill_no }}, <b style="color: red">Due: {{ $due }}</b></h4>
                            <br>
                          ...
                          <div class="modal-body">
                            <div class="box-body">
                                @if($sell)
                                <strong>Customer: {{ $sell->customer->name }} : {{ $sell->customer->code }}</strong>
                                @endif
